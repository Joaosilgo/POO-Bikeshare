 ...
 * @author João
 */
public class janelaAskCodigoCartaoAlugar extends StackPane {
    ...
    public janelaAskCodigoCartaoAlugar(Manager manager) {
        janela(manager);
    }
    ...
    private void janela(Manager manager) {
        ...
        ok.setOnAction(
                (ActionEvent event) -> {
                   ...
                   // ok.getScene().setRoot(new janelaPagamentoBilhete(  manager, type ,  valor));
                    // ok.getScene().setRoot();
                });
        cancel.setOnAction(
                (ActionEvent event) -> {
