 ...
 * @author João
 */
public class janelaPagamentoAnuidade extends StackPane {

    public janelaPagamentoAnuidade(Utilizador user, Manager manager, String type, String valor) {
        janela(user, manager, type, valor);

    }

    private void janela(Utilizador user, Manager manager, String type, String valor) {
        Image i = new Image(getClass().getResourceAsStream("bikeShareLogo.png"));
        ImageView img = new ImageView(i);
        img.setFitHeight(720);
        img.setFitWidth(360);

        Label labelTop = new Label("Criado Anuidade");
       ...
       Button cancel = new Button("CANCEL");
        ...
        HBox d = new HBox();
      //  d.getChildren().addAll(numberCard, txtRequest);
        d.setTranslateX(435);
           d.setTranslateY(340);
